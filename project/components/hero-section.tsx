...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-b from-background to-accent/10 pt-16">
      <div 
      ...
      <div className="container mx-auto px-4 z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <form onSubmit={handleSearch} className="flex flex-col sm:flex-row gap-4 max-w-xl mx-auto">
            ...
            <Button type="submit" size="lg" className="py-6 px-8 rounded-full">
              Explore
            </Button>
          </form>
